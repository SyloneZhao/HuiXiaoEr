...
namespace Sylone.Comm
{
    ...
    public class ExcelHelper : IDisposable
    {
        ...
        /// <returns></returns>
        public MemoryStream DataTableToExcel(DataTable table, string title, string sheedname)
        {
            ...
            sheedname = string.IsNullOrEmpty(sheedname) ? "sheet1" : sheedname;
            ISheet sheet = workBook.CreateSheet(sheedname);
